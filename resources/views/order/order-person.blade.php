                    ...
                    <div class="row">
                        <form class="form_order">
                            ...
                            <div class="dialog col-md-6">
                                ...
                                <input class="form_order__input" type="text" id="name" placeholder="Zde napište jméno" value="{{session('results')[0]}}" required>
                                <input class="form_order__input" type="text" id="name" placeholder="Zde napište příjmení" value="{{session('results')[1]}}" required>
                                <input class="form_order__input" type="text" id="name" placeholder="Zde napište datum narození" value="{{session('results')[2]}}" required>
                            </div>
